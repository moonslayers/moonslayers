...
export class TiempoProduccionPage {
  ...
  protected readonly timelineProjects: TimelineProject[] = [
    ...
    { year: '2023', icon: 'bi-boxes', color: 'text-success', titleKey: 'tiempoProduccion.project.almacenes', periodKey: 'tiempoProduccion.period.1year', roleKey: 'tiempoProduccion.role.frontend', tech: ['Angular 21', 'Laravel 12', 'MySQL', 'GitHub Actions'] },
    { year: '2024', icon: 'bi-bank', color: 'text-primary', titleKey: 'tiempoProduccion.project.creditos', periodKey: 'tiempoProduccion.period.ongoing', roleKey: 'tiempoProduccion.role.leader', tech: ['Angular 21', 'Laravel 12', 'MySQL', 'GitHub Actions'], isActive: true },
